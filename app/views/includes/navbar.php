<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav ml-auto">
     <?php if(session_status()==PHP_SESSION_NONE){
      ...
      <li class="nav-item <?php if($page=='home'){ echo 'active bg-danger';}?>" style="border-radius:10px; height:35px;margin-right:50px; width:90px;">
        <a class="nav-link font-weight-bold text-center" style="border-radius:10px; font-size:15px;<?php if($page!='home'){ echo 'color:black;';}?>" href="<?php echo URLROOT;?>">HOME</a>
      </li>
      <li class="nav-item <?php if($page=='about'){ echo 'active bg-danger';}?>" style="border-radius:10px;height:35px; margin-right:50px;width:90px;">
        <a class="nav-link font-weight-bold text-center"style="border-radius:10px; font-size:15px;<?php if($page!='about'){ echo 'color:black;';}?>"  
    ...
    <?php if(session_status()==PHP_SESSION_NONE){
      ...
      <a class="nav-link font-weight-bold text-center"style="border-radius:10px; font-size:15px;<?php if($page!='launchcampaign'){ echo 'color:black;';}?>"
      ...
      <a class="nav-link font-weight-bold text-center"style="border-radius:10px; font-size:15px;<?php if($page!='listsubscriber'){ echo 'color:black;';}?>"
      ...
      <a class="nav-link font-weight-bold text-center"style="border-radius:10px; font-size:15px;<?php if($page!='previouscampaign'){ echo 'color:black;';}?>"
    ...
    <?php else : ?>
      <li class="nav-item <?php if($page=='register'){ echo 'active bg-danger';}?>" style="border-radius:10px; margin-right:50px; height:35px; width:90px;">
        <a class="nav-link font-weight-bold text-center" style="border-radius:10px; font-size:15px;<?php if($page!='register'){ echo 'color:black;';}?>"
      ...
      <li class="nav-item <?php if($page=='login'){ echo 'active bg-danger';}?>" style="border-radius:10px;  height:35px;width:90px;">
        <a class="nav-link font-weight-bold text-center" style="border-radius:10px; font-size:15px; <?php if($page!='login'){ echo 'color:black;';}?>"
